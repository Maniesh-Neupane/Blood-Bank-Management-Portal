...
public class AdminLogin extends JFrame {
    ...
    public AdminLogin() {
        ...
        setTitle("LifeLine |  Admin Access");
        ...
        JLabel subTitle = new JLabel("Blood Bank System Management");
    ...
    private JTextField styledField(boolean isPass) {
        ...
        f.setMaximumSize(new Dimension(330, 45));
        f.setFont(new Font("SansSerif", Font.PLAIN, 14));

        // Force Light Theme Colors
        f.setBackground(Color.WHITE);
        f.setForeground(DARK_NAVY);
        f.setCaretColor(DARK_NAVY);
        f.setSelectionColor(ACCENT_RED);
    ...
    private void handleLogin() {
        ...
        try (Connection con = DBConnection.connect()) {
            ...
            JOptionPane.showMessageDialog(this,
                    "Database Connectivity Error: " + ex.getMessage());
        }
    }
